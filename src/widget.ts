...
export const DEFAULT_SETTINGS: WebchatSettings = {
  ...
  watermark: { enabled: true, html: 'Powered by <a href="https://brainigy.eu">brainigy.eu</a>' },
...
export function mergeSettings(base: WebchatSettings, ...patches: (WebchatSettingsOverrides | undefined)[]): WebchatSettings {
  ...
  for (const patch of patches) {
    ...
    result = {
      ...
      watermark: { ...result.watermark, ...(patch.watermark ?? {}) },
...
export function initWebchat(
  ...
  const watermark = element('div', 'watermark');
  ...
  function applySettings(): void {
    ...
    watermark.replaceChildren(renderWatermark(settings.watermark.html));
    watermark.hidden = !settings.watermark.enabled || !watermark.textContent?.trim();
